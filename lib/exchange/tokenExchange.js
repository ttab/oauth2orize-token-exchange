module.exports = function(options, issue) {
  ...
  return function(req, res, next) {
    ...
    var client = req[userProperty]
      ...
      , requestedTokenType = req.body.requested_token_type
      , subjectToken = req.body.subject_token
      , subjectTokenType = req.body.subject_token_type
      , actorToken = req.body.actor_token
      , actorTokenType = req.body.actor_token_type
      , wantComposite = req.body.want_composite;
